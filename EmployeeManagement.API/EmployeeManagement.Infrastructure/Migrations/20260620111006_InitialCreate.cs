        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_AttendanceDeviceLogs_AttendanceDevices_DeviceId",
                        column: x => x.DeviceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OffDaySchedules", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OffDaySchedules_Departments_DepartmentId",
                        column: x => x.DepartmentId,
                        principalTable: "Departments",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OffDaySchedules_Employees_EmployeeId",
                        column: x => x.EmployeeId,
                        principalTable: "Employees",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    LateByMinutes = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AttendanceDeviceLogs_EmployeeId_PunchTimeUtc",
                table: "AttendanceDeviceLogs",
                columns: new[] { "EmployeeId", "PunchTimeUtc" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OffDaySchedules_DepartmentId",
                table: "OffDaySchedules",
                column: "DepartmentId");

            migrationBuilder.CreateIndex(
                name: "IX_OffDaySchedules_EmployeeId",
                table: "OffDaySchedules",
                column: "EmployeeId");
        }
